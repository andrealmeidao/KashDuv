...
public class DespesaService {
    ...
    @Transactional
    public DespesaDTO atualizar(String id, DespesaDTO dto, String usuario) { Despesa d = encontrar(id, usuario); d.setDescricao(dto.getDescricao()); d.setValor(dto.getValor()); d.setCategoria(com.Kash.KashDuv.entity.Categoria.normaliza(dto.getCategoria())); d.setData(dto.getData()); return FinanceiroMapper.paraDto(repository.save(d)); }
    @Transactional
